...
from vehicles import Vehicles # not used in this example
...
class Menu():
    ...
    def getId(self):
        ...
        # check we have an int between 0 and 7
    ...
    def getPlanets(self):
        ...
        result = "Name: {} Population: {}".format(self.planets.name, self.planets.population)
        print (result)
        self.appendData(result)
    def getSpecies(self):
        ...
        result = "Name: {} Classification: {}".format(self.species.name, self.species.classification)
        print (result)
        self.appendData(result)
...
if __name__ == "__main__":
    # we only need to use the class, no need to instantiate it
    Menu().run()